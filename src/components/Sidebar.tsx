import { Laptop, Moon, Search, Settings as SettingsIcon, Sun } from "lucide-react";
  ...
  return (
    ...
    >
      {options.map((opt) => {
        ...
        return (
          // biome-ignore lint/a11y/useSemanticElements: icon-only segmented control inside a radiogroup
          <button
            key={opt.value}
            type="button"
            role="radio"
