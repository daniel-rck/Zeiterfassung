...
export function ReportChart({ buckets, locale }: { buckets: DayBucket[]; locale: string }) {
  if (buckets.length === 0) {
    return (
      <p className="text-sm text-[color:var(--color-text-3)]">Keine Daten im gewählten Zeitraum.</p>
    );
  }
