  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block text-sm font-medium text-[color:var(--color-text-1)]">{label}</span>
        {description && (
      ...
      <Switch id={id} checked={checked} onChange={onChange} disabled={disabled} ariaLabel={label} />
    </div>
  );
}
