...
const TONE: Record<Tone, string> = {
  ...
  warn: "bg-[color:var(--color-warn-500)]/10 text-[color:var(--color-warn-600)] ring-1 ring-inset ring-[color:var(--color-warn-500)]/20 dark:text-[color:var(--color-warn-500)]",
  danger:
